...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.line_id)
        self.line_title = QtWidgets.QLineEdit(self.formLayoutWidget_2)
        self.line_title.setObjectName("line_title")
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.line_title)
        self.line_roast = QtWidgets.QLineEdit(self.formLayoutWidget_2)
        self.line_roast.setObjectName("line_roast")
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.line_roast)
        self.line_ground = QtWidgets.QLineEdit(self.formLayoutWidget_2)
        self.line_ground.setObjectName("line_ground")
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.ItemRole.FieldRole, self.line_ground)
        self.line_about = QtWidgets.QLineEdit(self.formLayoutWidget_2)
        self.line_about.setObjectName("line_about")
        self.formLayout_2.setWidget(4, QtWidgets.QFormLayout.ItemRole.FieldRole, self.line_about)
        self.line_price = QtWidgets.QLineEdit(self.formLayoutWidget_2)
        self.line_price.setObjectName("line_price")
        self.formLayout_2.setWidget(5, QtWidgets.QFormLayout.ItemRole.FieldRole, self.line_price)
        self.line_volume = QtWidgets.QLineEdit(self.formLayoutWidget_2)
        self.line_volume.setObjectName("line_volume")
        self.formLayout_2.setWidget(6, QtWidgets.QFormLayout.ItemRole.FieldRole, self.line_volume)
